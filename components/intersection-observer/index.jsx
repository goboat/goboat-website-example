...
const register = (root, threshold = 0.5, element, onVisible) => {
  let key = `${root ? root : 'root'}-${threshold}`;

  let intersectionObserver = (intersectionObserverList[key] =
    intersectionObserverList[key] || create(root, threshold));
